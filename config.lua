...
-- Hack Config
Config.HackType = "laptop" -- Either "laptop" or "memory" as of Version 1.1 ---- "laptop" requires https://github.com/Jesper-Hustad/NoPixel-minigame/tree/main/fivem-script/hacking
